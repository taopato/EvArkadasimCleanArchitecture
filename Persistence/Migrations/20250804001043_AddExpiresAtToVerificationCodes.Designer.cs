...
namespace Persistence.Migrations
{
    ...
    [Migration("20250804001043_AddExpiresAtToVerificationCodes")]
    partial class AddExpiresAtToVerificationCodes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Share", b =>
                {
                    b.HasOne("Domain.Entities.Expense", "Harcama")
                        .WithMany("Shares")
                        .HasForeignKey("HarcamaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("User", "PaylasimUser")
                        .WithMany()
                        .HasForeignKey("PaylasimUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Harcama");

                    b.Navigation("PaylasimUser");
                });
